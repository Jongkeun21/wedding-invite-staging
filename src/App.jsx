...
import page_map2 from './assets/pages/09_map2.png';
import page_guestbook from './assets/pages/10_guestbook.png';
      ...
      <div className="tab-content">
        {activeTab === 'groom' ? (
          <div className="account-info">
            <p className="bank-name">농협은행 217064-56-004790</p>
            <p className="account-holder">예금주: 이강수</p>
            <button className="copy-btn" onClick={() => handleCopy('21706456004790')}>계좌번호 복사하기</button>
            <hr className="account-divider" />
            <p className="bank-name">신한은행 110-416-876745</p>
            <p className="account-holder">예금주: 유항숙</p>
            <button className="copy-btn" onClick={() => handleCopy('110416876745')}>계좌번호 복사하기</button>
            <hr className="account-divider" />
...
export default function App() {
  ...
  const pages = [
    ...
    },
    {
      ...
      bg: 'transparent',
      content: (
        <PageLayout image={page_map2} alt="page_map2" />
      )
    },
    {
      id: 9,
